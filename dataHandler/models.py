...
class UserData(models.Model):
    ...
    last_name = models.CharField('second name',max_length = 30)
    sex = models.IntegerField('sex')
    status = models.TextField('user status',null = True)
    city_id = models.CharField('city_id',max_length = 100,null = True)
    city_title = models.CharField('city_title',max_length = 100,null = True)
    ...
    country_id = models.CharField('country_id',max_length = 100,null = True)
    country_title = models.CharField('country_title',max_length = 100,null = True)
    domain = models.CharField('domain',max_length = 50)
    education = models.TextField('education',null = True)
    home_town = models.CharField('home town',max_length = 100,null = True)
